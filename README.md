# 🚀 Mission Control powered by Cosmo Pup
...
You can start editing the page by modifying any route segment under `app/`.
...
This large display will be mounted on the wall of the control room to help coordinate the launch sequence. Data is pulled from the API to make sure the countdown is accurate.
...
- Only display 5 launches at a time.
